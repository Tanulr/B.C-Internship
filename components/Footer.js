...
import zemoologo from "../assets/zemoologo.png";
import Link from "next/link";
import Image from "next/image";

const Footer = () => {
  return (
    <footer className="p-4 bg-slate-100 rounded-lg shadow md:px-6 md:py-8 ">
      <div className="sm:flex sm:items-center sm:justify-evenly">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-lg text-black sm:mb-0">
          <li>
            <Link href="/">
      ...
      <span className="block text-lg text-blasck sm:text-center">
        © 2022{" "}
